...
/*
#define SESSION_STATE_INIT    1
#define SESSION_STATE_SF      2
#define SESSION_STATE_S0      3
#define SESSION_STATE_S1      4
#define SESSION_STATE_S2      5
#define SESSION_STATE_S3      6
#define SESSION_STATE_REJ     7
#define SESSION_STATE_RSTOS0  8
#define SESSION_STATE_RSTO    9
#define SESSION_STATE_RSTR    10
#define SESSION_STATE_SH      11
#define SESSION_STATE_RSTRH   12
#define SESSION_STATE_SHR     13
#define SESSION_STATE_OTH     14
#define SESSION_STATE_ESTAB   15
#define SESSION_STATE_S4      16
#define SESSION_STATE_S2F     17
#define SESSION_STATE_S3F     18
*/

#define SESSION_STATE_INIT      0x00
#define SESSION_STATE_OTH       0x01
#define SESSION_STATE_REJ       0x02
#define SESSION_STATE_RSTO      0x04
#define SESSION_STATE_RSTOS0    0x08
#define SESSION_STATE_RSTR      0x10
#define SESSION_STATE_S0        0x20
#define SESSION_STATE_S1        0x40
#define SESSION_STATE_S2        0x80
#define SESSION_STATE_S3        0x100
#define SESSION_STATE_SF        0x200
#define SESSION_STATE_SH        0x400

#define SESSION_STATE_RSTRH     0x800
#define SESSION_STATE_SHR       0x1000
#define SESSION_STATE_ESTAB     0x2000
#define SESSION_STATE_S4        0x4000
#define SESSION_STATE_S2F       0x8000
#define SESSION_STATE_S3F       0x10000
