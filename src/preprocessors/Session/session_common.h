...
typedef struct _SessionControlBlock
{
    ...
    long       first_data_seen; //zhbit jacky
    long       last_data_seen1; //zhbit jacky
    ...
    long two_seconds_same_host;
    long two_seconds_same_server;
    long two_seconds_same_host_and_server;
    long two_seconds_same_host_syn_error;
    long two_seconds_same_server_syn_error;
    long two_seconds_same_host_rej_error;
    long two_seconds_same_server_rej_error;

    long before_100_same_host;
    long before_100_same_server;
    long before_100_same_host_and_server;
    long before_100_same_host_differ_server;
    long before_100_same_host_same_source_port;
    long before_100_same_host_and_server_differ_source_ip;
    long before_100_same_host_syn_error;
    long before_100_same_host_and_server_syn_error;
    long before_100_same_host_rej_error;
    long before_100_same_host_and_server_rej_error;

    snort_ip    origin_client_ip;
    snort_ip    origin_server_ip;
    long        origin_client_port;
    long        origin_server_port;
    int         flagAlert;
    int         flagTrackConnection;
    /*************zhbit jacky******************/
