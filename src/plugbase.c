...
#include "detection-plugins/sp_wrong_fragment_check.h" //zhbit jacky
#include "detection-plugins/sp_duration_check.h" //zhbit jacky
#include "detection-plugins/sp_srcBytes_check.h" //zhbit jacky
#include "detection-plugins/sp_dstBytes_check.h" //zhbit jacky
#include "detection-plugins/sp_session_flag_check.h" //zhbit jacky

#include "detection-plugins/sp_twoSecondsSameDstHostSessions_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstServiceSessions_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstHostSynErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstServiceSynErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstServiceRejErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstHostRejErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstHostServiceRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstHostDiffServiceRate_check.h" //zhbit jacky
#include "detection-plugins/sp_twoSecondsSameDstServiceDiffDstHostRate_check.h" //zhbit jacky


#include "detection-plugins/sp_before100SameDstHostSessions_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostServiceSessions_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostServiceRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostSourcePortRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostServiceDiffSIPRate_check.h"  //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostSynErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostRejErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostServiceRejErrorRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostDiffServiceRate_check.h" //zhbit jacky
#include "detection-plugins/sp_before100SameDstHostServiceSynErrorRate_check.h" //zhbit jacky
...
void RegisterRuleOptions(void)
{
    ...
    SetupIpProto();
    SetupIpSameCheck();
    SetupWrongFragmentCheck();//zhbit jacky
    SetupDurationCheck();//zhbit jacky
    SetupSessionFlagCheck(); //zhbit jacky
    SetupSrcBytesCheck();//zhbit jacky
    SetupDstBytesCheck();//zhbit jacky

    SetupTwoSecondsSameDstHostSessionsCheck();//zhbit jacky
    SetupTwoSecondsSameDstHostServiceRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstHostSynErrorRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceSynErrorRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstHostDiffServiceRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstHostRejErrorRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceDiffDstHostRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceRejErrorRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceSessionsCheck();//zhbit jacky

    SetupBefore100SameDstHostSynErrorRateCheck();//zhbit jacky
    SetupBefore100SameDstHostServiceSynErrorRateCheck();//zhbit jacky
    SetupBefore100SameDstHostRejErrorRateCheck();//zhbit jacky
    SetupBefore100SameDstHostSessionsCheck();//zhbit jacky
    SetupBefore100SameDstHostServiceSessionsCheck();//zhbit jacky
    SetupBefore100SameDstHostSourcePortRateCheck();//zhbit jacky
    SetupBefore100SameDstHostServiceRejErrorRateCheck();//zhbit jacky
    SetupBefore100SameDstHostServiceDiffSIPRateCheck();//zhbit jacky
    SetupBefore100SameDstHostDiffServiceRateCheck();//zhbit jacky
    SetupBefore100SameDstHostServiceRateCheck();//zhbit jacky
    /*SetupTwoSecondsSameDstHostSessionsCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceSessionsCheck();//zhbit jacky
    SetupTwoSecondsSameDstHostSynErrorRateCheck();//zhbit jacky
    SetupTwoSecondsSameDstServiceSynErrorRateCheck();//zhbit jacky
